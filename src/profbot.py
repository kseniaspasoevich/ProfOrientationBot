...
async def process_help_command(message: types.Message):
    await message.reply('Напиши мне что-нибудь, и я отправлю этот текст тебе в ответ! Пока не расписали логику бота(')
...
async def stud_organisations_button(message: types.Message):
    await message.reply("Их очень много. Можем расписать подробно, если заинтересованы")
